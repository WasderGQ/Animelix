...
{
    public class UnityProgressBar : VideoPlayerButton ,IEndDragHandler,IBeginDragHandler
    {
        [FormerlySerializedAs("_playPause")] [SerializeField]private UnityPlayPause unityPlayPause;
        ...
        {
            ButtonStatus = false;
            while(unityPlayPause.ButtonStatus && !ButtonStatus && _videoPlayer.time < _videoPlayer.length)
            {
